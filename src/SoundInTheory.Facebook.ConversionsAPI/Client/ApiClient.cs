...
namespace SoundInTheory.Facebook.ConversionsAPI.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = SoundInTheory.Facebook.ConversionsAPI.Client.Configuration.Default;
            RestClient = new RestClient("https://graph.facebook.com/v8.0");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://graph.facebook.com/v8.0).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? SoundInTheory.Facebook.ConversionsAPI.Client.Configuration.Default;
        ...
        public ApiClient(String basePath = "https://graph.facebook.com/v8.0")
        {
